...
?>
	...
	<div class="form-group"><!-- Photo ou avatar de l'utilisateur -->
		...
		<div class="row">
			...
			<div class="col-md-2" id="usrfipho_currentFile">
				<a href="<?=base_url()?>www/uploads/<?= $user->usrfipho ?>" target="_new" class="btn btn-default btn-xs">
					<i class="glyphicon glyphicon-file"></i> <?= $this->lang->line('form.button.download')?>
				</a>
			</div>
			<div class="col-md-2" id="usrfipho_deleteButton">
				<a href="#" onclick='deleteFile_usrfipho()' class="btn btn-default btn-xs">
